...
export {default as CustomerImages} from './CustomerImages/Customer';
export {default as CustomerRemarks} from './CustomerRemarks/CustomerRemarks';
export {default as FuelPump} from './FuelPump/FuelPumpMain';
